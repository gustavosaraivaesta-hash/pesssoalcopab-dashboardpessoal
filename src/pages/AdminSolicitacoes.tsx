...
import { FileText, Clock, CheckCircle2, XCircle, ArrowLeft, RefreshCw, Eye, Check, X } from "lucide-react";
          ...
          {selectedRequest && (
            <div className="space-y-4">
              ...
              <div className="p-4 border rounded-lg">
                <Label className="text-sm font-semibold mb-2 block">Dados do Militar</Label>
